...
public class OnlineCoursesAnalyzer {
    ...
    public Map<String, Integer> getPtcpCountByInst() {
        ...
        Map<String, Integer> Q1 = courseStream.collect(Collectors.groupingBy(Course::getInstitution, Collectors.summingInt(Course::getParticipants)));
    ...
    public Map<String, Integer> getPtcpCountByInstAndSubject() {
        Stream<Course> courseStream = courses.stream();
        Map<String, Integer> Q2 = courseStream.collect(Collectors.groupingBy(Course::getICS, Collectors.summingInt(Course::getParticipants)));
        Map<String, Integer> Q2new = new LinkedHashMap<>();
        List<Map.Entry<String,Integer>> list = new ArrayList<Map.Entry<String,Integer>>(Q2.entrySet());
